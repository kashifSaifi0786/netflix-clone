...
import PlayButton from "../billboard/play-button";
...
const InfoModel: React.FC<InfoModelProps> = ({ currentUser, movies }) => {
                    ...
                    <div className="relative h-96">
                        ...
                        <div className="absolute bottom-[10%] left-10">
                            ...
                            <div className="flex flex-row gap-4 items-center">
                                ...
                                <FavoriteButton currentUser={currentUser} movieId={data?.id || ''} />
                            </div>
                        </div>
                    </div>
